...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/10/26 20:51:08 by mdamouh           #+#    #+#              #
#    Updated: 2025/11/04 08:56:30 by mdamouh          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
      ...
      ft_strlcat.c ft_strlcpy.c ft_strmapi.c ft_strncmp.c ft_strnstr.c ft_strrchr.c \
